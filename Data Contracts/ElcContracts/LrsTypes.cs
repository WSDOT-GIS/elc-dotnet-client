...
namespace Wsdot.Elc.Contracts
{
    ...
    public enum LrsTypes
    {
        ...
        Ramp = 4,
        /// <summary>Route is in the Ferry Terminal or Proposed Routes (FTProp) LRS Layer</summary>
        FerryTerminalOrProposed = 8,
        /// <summary>Route is in the Turnbacks layer</summary>
        Turnback = 16
